	...
	<?php
							...
							$rw_estable=mysqli_fetch_array($sql_estable);
							 ?>
										...
										<table class="clase_table" cellspacing="0"  border="0" style="width: 40%; text-align: left; font-size: 9pt;">
													<tr>
															<td style="width: 100%; text-align: left; font-size: 7pt;" >
															<p style="font-size:13px; text-align: center;"><b>
							<?php echo $rw_emisor['razonSocial'];?>
							<BR>
							<?php echo $rw_emisor['nombreComercial'];?></b><BR>
							<span style="font-size:18px; text-align: center;"><b>R.U.C.: <?php echo $rw_emisor['ruc'];?></b>
</span><span style=" text-align:left; font-size:10px;">
							<hr>
																			...
																			<td colspan="3" style="widtd: 13%; text-align: right;"><?php echo $rw_factura['totalDescuento']; ?></td>
																				...
																				<td colspan="3" style="widtd: 26%; text-align: right;"> <b>IVA 12%</b> </td>
																					<td colspan="3" style="widtd: 13%; text-align: right;"> <?php echo $rw_factura['iva12']; ?></td>
																						...
																						<tr>
																							<th colspan="6" >	<hr>
																							<p style="font-size: 14px;text-align: center;"><b>TOTAL A PAGAR <?php echo $rw_factura['valorTotal']; ?></b></p>
<hr>
																						</th>
																						</tr>
																						<tr>
																						<td colspan="6"style="width: 100%; text-align: left">
																						<span style="font-size: 12px;">	<b>Información Adicional</b></span><br>
																							<?php
