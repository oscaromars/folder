	...
	<table cellspacing="0" style="width: 100%; text-align: left;">
	       <tr>
               <td style="width: 45%;text-align:center" >
			       <img style="width: 80%;" src="<?php echo $rw_emisor['dirLogo'];?>" alt="Logo">
                        <br>
			            <table class="clase_table" cellspacing="0"  style="width: 100%; text-align: left; font-size: 10pt;">
						       <tr>
							       <td style="width: 100%; text-align: left; font-size: 7pt;" >
                                       ...
                                       <?php echo $rw_emisor['direccionMatriz'];?>
		                               <BR><BR>
		                               <b>	DIRECCIÓN ESTABLECIMMIENTO:</b>
                                       <?php echo $rw_estable['direccion'];?>
		                               <BR><BR>
		                               <b>
                                          <?php $regimenr=$rw_emisor['regimenRimpe'];
		                               ...
		                               <?php if ($rw_emisor['resolucionAgenteRetencion']=="") {
					                            echo "";
                                                  ...
                                                  echo "<BR><BR><b>AGENTE RETENCION Nº:</b>" .$rw_emisor['resolucionAgenteRetencion'];
		                                     }
		                                     if ($rw_emisor['contribuyenteEspecial']=="") {
					                            echo "";
		                                     }
		                                     else {
                                                  echo "<BR><BR><b>CONTRIBUYENTE ESPECIAL Nº:</b>" .$rw_emisor['contribuyenteEspecial'];
		                                     }
			                                 if ($rw_emisor['obligadoContabilidad']=="") {
						                        echo "";
			                                 }
			                                 else {
                                                  echo "<BR><BR><b>OBLIGADO A LLEVAR CONTABILIDAD:</b>" .$rw_emisor['obligadoContabilidad'];
			                                 }
			                           ?>
                                   </td>
							</tr>
                    ...
                    <table class="clase_table" cellspacing="0" style="width: 100%; text-align: left; font-size: 9pt;">
                           <tr>
                               <td style="width: 100%" >
                                   ...
                                   <p style="font-size:12px;"><b>COMPROBANTE DE RETENCIÓN <BR>No.</b>
                                      <b><?php echo $rw_estable['codigo']."-".$rw_pemisor['codigo']."-".$numero_retencion;?></b>
                                      <BR><BR>FECHA Y HORA DE AUTORIZACIÓN:
                                      <b> <?php echo $Autorizacion;?></b>
                                      <BR><BR>NÚMERO DE AUTORIZACIÓN
                                      <b><BR><?php echo $nAutorizacion;?></b>
                                      <BR><BR>AMBIENTE: <?php
                                                        if ($ambiente==1) {
                                                          echo "PRUEBA";
                                                        } else {
                                   ...
                                   <p style="text-align:center"><b>CLAVE DE ACCESO</b>
                                   <BR><?php  	barcode('barra/'.$acceso.'.png', $acceso, 35, 'horizontal', 'code128', true);
                                               ?>
