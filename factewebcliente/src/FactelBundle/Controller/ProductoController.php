...
class ProductoController extends Controller {
    ...
    public function productosAction() {
        ...
        $count = $em->getRepository('FactelBundle:Producto')->findcantidadProductos($idEmisor, $sSearch);
        ...
        foreach ($entities as $entity) {
            ...
            $ivapor = $entity->getImpuestoIVA()->gettarifa();
            $ivavalor = number_format($entity->getPrecioUnitario()*(1+($ivapor/100)),2,'.','');
            ...
            $clienteArray[$i] = [$entity->getId(), $entity->getCodigoPrincipal(), $entity->getCodigoAuxiliar(), $entity->getNombre(), $entity->getPrecioUnitario(), $iva, $ice, $IRBPNR, $tarifa, $entity->getTieneSubsidio(), $entity->getPrecioSinSubsidio(), $ivavalor];
            //$clienteArray[$i] = [$entity->getId(), $entity->getCodigoPrincipal(), $entity->getNombre(), $entity->getPrecioUnitario(), $iva, $ice, $IRBPNR, $tarifa, $entity->getTieneSubsidio(), $entity->getPrecioSinSubsidio()];
            $i++;
        }
