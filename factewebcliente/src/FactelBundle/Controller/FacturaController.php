...
//$this->funtionCrearXmlPDF($entity->getId());
    ...
    public function createAction(Request $request) {
        ...
        //    $texto = "x".$valortotalx." la Factura, Cliente Final No Puede Facturar Mas de 50 Dolares..";
        //    $this->get('session')->getFlashBag()->add(
        //            'notice', $texto
        //    );
        //    return $this->redirect($this->generateUrl('factura_new', array()));
        ...
        $secuencial = str_pad($ptoEmision[0]->getSecuencialFactura(),9,"0",STR_PAD_LEFT);
        ...
        //if ($tipoIdentificacion == "07") {
        if (($tipoIdentificacion == "07") && ($importeTotal > 50)) {
            $texto = "Cliente Final No Puede Facturar Mas de 50 Dolares..";
            $this->get('session')->getFlashBag()->add(
                    'notice', $texto
            );
            return $this->redirect($this->generateUrl('factura_new', array()));
